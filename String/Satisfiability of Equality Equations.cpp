...
string equations[i] is of length 4 and takes one of two different forms: "xi==yi" or "xi!=yi".Here, xi and yi are lowercase letters (not necessarily different) 
...
class Solution {
    ...
    int find(int x) {
        ...
        //here recursion works gives the variable of same block
    }
public:
